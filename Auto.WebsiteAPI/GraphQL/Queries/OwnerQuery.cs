...
public class OwnerQuery : ObjectGraphType
{
    ...
    public OwnerQuery(IAutoDatabase db)
    {
        ...
        Field<OwnerGrahType>("ownerById").Argument<int>("id").Resolve(OwnerById);
        Field<ListGraphType<OwnerGrahType>>("owners").Resolve(GetOwners);
        Field<OwnerGrahType>("ownerByFullName").Argument<string>("firstName").Argument<string>("lastName").Resolve(OwnerByFullName);
        Field<OwnerGrahType>("ownerByVehicleCode").Argument<string>("code").Resolve(OwnerByVehicleCode);
