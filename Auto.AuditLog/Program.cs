...
namespace Auto.AuditLog
{
    class Program
    {
        ...
        {
            var csv =
                $"{message.FirstName},{message.LastName},{message.Email},{message.VehicleCode},{message.ListedAtUtc:O}";
        ...
        private static IConfigurationRoot ReadConfiguration()
        {
            ...
            return new ConfigurationBuilder().SetBasePath(basePath).AddJsonFile("appsettings.json").AddEnvironmentVariables().Build();
        }
    }
}